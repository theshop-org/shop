...
if (is_product_category()) {
    ...
    // Default: all published products
    $args = array(
        'status' => 'publish',
        'limit' => -1,
        'return' => 'ids',
						...
						<div class="offcanvas-body">
							<div class="mobile-offcanvas">
								<div class="mobile-offcanvas__body">
									<a class="main-header__search" data-bs-toggle="offcanvas" href="#offcanvasExampleMobile" role="button" aria-controls="offcanvasExampleMobile" style="display: flex; width: 100%; justify-content: space-between;">
											SEARCH
			...
			<?php if(isset($first_half) && $first_half): ?>
				<?php foreach ($first_half as $item): ?>
					<?php if (!empty($item->children)): ?>
						<div class="dropdown">
							<a 
								class="main-header__menu--item dropdown-toggle" 
								href="<?php echo esc_url($item->url); ?>" 
								target="<?php echo esc_attr($item->target); ?>"
							>
								<?php echo esc_html($item->title); ?>
			...
			<div class="products-header">
				...
				<div class="products-grid-change">
					...
					<div class="grid-style" id="gridStyleTwo">  
						<svg width="8" height="15" viewBox="0 0 9 19" fill="none" xmlns="http://www.w3.org/2000/svg">
